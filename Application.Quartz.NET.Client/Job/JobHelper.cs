...
namespace Application.Quartz.NET.Client
{
    public class JobHelper
    {
        ...
        public JobHelper()
        {
            _scheduler = RemoteClient.Instance;
        }
        ...
        /// <returns></returns>
        public async Task RunJob(Customer_JobInfo jobInfo)
        {
            ...
            TriggerKey triggerKey = _createTriggerKey(jobInfo.TriggerName, jobInfo.TriggerGroupName);
        ...
        public bool DeleteJob(Customer_JobInfo jobInfo)
        {
            ...
            _scheduler.PauseTrigger(triggerKey);//暂停
            _scheduler.UnscheduleJob(triggerKey);//Remove
        ...
        private int _changeType(TriggerState triggerState)
        {
            ...
            {                
                ...
                case TriggerState.None: return 5;
                default: return -1;
            }
